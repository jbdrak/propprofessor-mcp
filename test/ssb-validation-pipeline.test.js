...
/**
 * Direct tests for lib/ssb-validation-pipeline.js (plan Task 4.1).
 *
 ...
 * fake validate/apply functions — no SSB client, no network.
 */

const { describe, it } = require('node:test');
const assert = require('node:assert/strict');
const { runValidationPipeline, selectTopGlobal, selectTopPerBucket } = require('../lib/ssb-validation-pipeline');
