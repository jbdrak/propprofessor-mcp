...
} = require('../scripts/query-ssb');

describe('query-ssb CLI parsing', () => {
...
describe('query-ssb CLI command execution', () => {
  ...
  it('doctor fails the node check on a stale Node 18 floor', () => {
    ...
    const { getNodeVersionStatus } = require('../scripts/query-ssb');
...
describe('query-ssb CLI: --reset clears score timeline (audit finding #1 defense)', () => {
  it('main() calls clearScoreTimeline when --reset is passed', async () => {
    ...
    Module._load = function (request, parent, isMain) {
      ...
      if (request.endsWith('ssb-risk-score')) {
    ...
    try {
      ...
      delete require.cache[require.resolve('../scripts/query-ssb')];
      const cli = require('../scripts/query-ssb');
