...
const BASKETBALL_MODULE_PATH = require.resolve('../lib/ssb-basketball-game-context');
...
const { parseGameString } = require('../lib/ssb-game-context');
...
describe('getGameContext', () => {
  it('exports getGameContext', () => {
    const mod = require('../lib/ssb-game-context');
