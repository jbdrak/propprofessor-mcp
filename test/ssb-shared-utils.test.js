...
const { compactRow, resolveMarketName } = require('../lib/ssb-shared-utils');
...
describe('DEFAULT_LEAGUES', () => {
  ...
  it('exports every league the SSB backend supports', () => {
  ...
  it('covers both the main US sports and the international / niche leagues', () => {
    ...
    // line above and re-verify the ssb backend actually supports it.
...
describe('createCrossCallMemoizedQuery', () => {
  const { createCrossCallMemoizedQuery } = require('../lib/ssb-shared-utils');
