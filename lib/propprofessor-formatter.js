 ...
 * @param {Object} [bet.elo] - Additive Tennis Elo shadow context (game-context research).
...
function formatBetCompact(bet = {}) {
  ...
  return {
    ...
    // Elo shadow-context is additive and whitelisted so bets-mode plays
    // keep the Tennis Elo payload record-candidates reads into featureSnapshot.
    elo: bet.elo || null
  };
}
