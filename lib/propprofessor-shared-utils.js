...
const MARKET_ALIASES = {
  ...
  // set_handicap routes to Game Handicap — the backend doesn't have a distinct
  // Set Handicap feed for tennis; it returns Game Handicap data under that name.
  set_handicap: { TENNIS: 'Game Handicap' },
