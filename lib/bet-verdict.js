...
function applyFinalVerdict(target) {
  ...
  const validationFailed =
    ...
    (Array.isArray(target.finalWarnings) &&
      target.finalWarnings.includes('validation-failed') &&
      target.validationBudgetSkipped !== true);
  ...
  // PASS' in SSB's model. This must happen here (not only in
