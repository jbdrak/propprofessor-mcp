...
/** @type {import('./ssb-lru-cache').LruCache | null} */
 ...
 * Reads from the SSB_ODDS_HISTORY_LOOKBACK_HOURS environment variable
 ...
 */
function getOddsHistoryLookbackHours(value = process.env.SSB_ODDS_HISTORY_LOOKBACK_HOURS) {
 ...
 * Reads from SSB_CACHE_MAX_ENTRY_SIZE_BYTES, defaulting to 5 MB.
...
function getCacheMaxEntrySizeBytes() {
  const parsed = Number(process.env.SSB_CACHE_MAX_ENTRY_SIZE_BYTES);
