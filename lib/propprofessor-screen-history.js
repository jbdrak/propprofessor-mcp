...
async function hydrateScreenRowsWithHistory(
  rows,
  opts = /** @type {{ client?: any, lookbackHours?: number, historySportsbooks?: string[], preferredBook?: string, sharpBooks?: string[], concurrency?: number, minIntervalMs?: number, throttleCooldownMs?: number, enableLineFallback?: boolean, sharpOddsProvider?: any, preferSharpOddsHistory?: boolean }} */ ({})
) {
  const {
    client,
