 ...
 * ~/.ssb-for-agents/signal-calibration.json. Aggregate enough data and you
...
const CALIBRATION_FILE =
  process.env.PP_SIGNAL_CALIBRATION_FILE || path.join(os.homedir(), '.ssb-for-agents', 'signal-calibration.json');
