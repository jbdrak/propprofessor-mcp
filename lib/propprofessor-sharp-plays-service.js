      ...
      const rankedArgs = {
        ...
        ...(quickScreenAggregate
          ? {
              ...
              // Reserve one bounded recovery game for likely skipped candidates.
...
async function runSharpPlays(
  ...
  // budget instead of first-come starvation under concurrency. The count
  ...
  // activeAggregatePairCount. Dividing the 40-call initial allocation by
  // the raw league×market fan-out count starves live pairs down to ~1
