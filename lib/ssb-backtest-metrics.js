 ...
 *
 * The SSB API does not serve historical resolved results, so outcomes
 ...
 * estimates (model, market fair) track settled binary outcomes. Each row
...
const DEFAULT_PROBABILITY_FIELDS = ['marketFairProbability', 'modelWinProbability'];
