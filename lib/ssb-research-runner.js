...
const { mapWithConcurrency } = require('./ssb-shared-utils');
const { isPlayerSelection } = require('./ssb-selection-type');
...
async function runResearchOnTopRows({
  ...
  const results = await mapWithConcurrency(
    ...
    async (row) => {
      ...
      // Route player selections to player_context, everything else to game_context.
