...
const LEAGUE_CONFIGS = {
  ...
  TENNIS: {
    ...
    minimumScore: 1.9,
    marketPriorities: [
      { match: 'moneyline', weight: 2.4 },
      { match: 'total games', weight: 2.3 },
      { match: 'set handicap', weight: 2.1 },
      // Kept available for explicit queries, but not a preferred default.
      { match: 'game handicap', weight: 1.0 },
      { match: 'point spread', weight: 1.0 },
      { match: 'total sets', weight: 1.0 }
    ]
  },
  UFC: {
    displayName: 'UFC',
