...
function buildScreenTools() {
  return [
    ...
    },
    {
      name: 'quick_screen',
      description:
        'SCAN — one-call sharp-play scanner across leagues × markets. Returns ranked results with tiers, edge, movement, and validation. NOTE: tier/kaiCall/edge/screenScore are signal-quality ratings (what sharp books are doing), NOT win-probability predictions.',
      inputSchema: {
        type: 'object',
