...
function buildFantasyOptimizerTool() {
  return {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        leagues: {
          ...
          items: { type: 'string' },
          description:
            'League filter, e.g., ["NBA", "MLB"]. Defaults to NBA, MLB, NFL, NHL, WNBA, NCAAB, NCAAF, Soccer, Tennis, UFC, NBASL — every league the SSB backend supports.'
        },
...
function buildMetaTools() {
  return [
    ...
    },
    {
      ...
      description:
        'REGISTRY — discover available main-line and exact player/pitcher prop markets for a sport on a specific book. Returns markets plus propMarkets. Call before scan or quick_screen; includeProps:true opts into manual prop scans, which increase fan-out and rate-limit risk.',
      inputSchema: {
        type: 'object',
