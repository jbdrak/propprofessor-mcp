    ...
    inputSchema: {
      ...
      properties: {
        ...
        leagues: {
          ...
          items: { type: 'string' },
          description:
            'Specific leagues to query. Default: [NBA, MLB, NFL, NHL, WNBA, NCAAB, NCAAF, Soccer, Tennis, UFC, NBASL] — every league the SSB backend supports.'
        },
    ...
    inputSchema: {
      ...
      properties: {
        leagues: {
          ...
          items: { type: 'string' },
          description:
            'Leagues to check for alerts. Default: NBA, MLB, NFL, NHL, WNBA, NCAAB, NCAAF, Soccer, Tennis, UFC, NBASL — every league the SSB backend supports.'
        },
        lookbackHours: {
          type: 'number',
