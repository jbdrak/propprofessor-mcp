...
| Version | Supported                     |
| ------- | ----------------------------- |
| 2.10.x  | Yes — current release         |
| 2.9.x   | Yes — receives security fixes |
| 2.8.x   | Security fixes only           |
| < 2.8   | No — please upgrade           |

## Reporting a Vulnerability

If you discover a security issue, please report it privately through [GitHub Security Advisories](https://github.com/jbdrak/ssb-for-agents/security/advisories/new) so we can fix it before public disclosure. Do not open a public issue.
...
- Vulnerabilities in the SSB API itself (report to SSB directly)
